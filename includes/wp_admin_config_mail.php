...
function fsf_display_settings_page()
{
    if (isset($_POST['fsf_save_settings'])) {
        ...
        echo '<div class="notice notice-success"><p>' . __('Settings saved.', 'funnel-services-form') . '</p></div>';
    }

    $email_subject = get_option('fsf_email_subject', __('Services Quote', 'funnel-services-form'));
